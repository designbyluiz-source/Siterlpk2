...
/**
 * Ordem da galeria: primeiro espaços do **térreo** (coliving, hall, coworking),
 * depois **terraço** (gourmet, piscinas). Cada slide liga «Ver Planta» ao pavimento certo.
 */
const IMAGES: readonly AreaComumSlide[] = [
  ...
  { src: '/areas-comuns/coworking.jpg', alt: 'Coworking', pavimentoId: 'terreo', floorLabel: 'Térreo' },
  { src: '/areas-comuns/gourmet.jpg', alt: 'Espaço gourmet', pavimentoId: 'terraco', floorLabel: 'Terraço' },
...
function irParaPlantaDoPavimento(pavimentoId: AreaComumSlide['pavimentoId']) {
  window.dispatchEvent(
    new CustomEvent(PLANTAS_SELECIONAR_PAVIMENTO, {
      detail: { pavimentoId } satisfies PlantasSelecionarPavimentoDetail,
    }),
  )
...
export default function AreasComuns() {
  ...
  return (
    ...
    >
      <div className="container-ambar mb-10">
      ...
      <div className="relative w-full overflow-hidden">
        <div className="flex items-stretch justify-center gap-11 px-4">
          ...
          {/* Main image */}
          <div className="relative w-full max-w-[803px] h-[320px] md:h-[452px] shrink-0 overflow-hidden">
            <img
              src={main.src}
              alt={main.alt}
            ...
            <div className="absolute inset-x-0 bottom-0 px-[29px] pb-[19px] flex items-end justify-between">
              <div className="flex gap-3 items-center">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    irParaPlantaDoPavimento(main.pavimentoId)
                  }}
